...
* Prefer explicit structure, explicit ownership, and predictable behavior.
...
* Optimize for reviewability. Do not optimize for fewer files.
...
* Prefer inferred return types when inference is correct and precise.
* Add explicit return types only when they intentionally define a public contract, prevent undesirable inference, constrain implementation, hide implementation details, are required for recursion, or materially improve type safety/readability.
